...
def train_one_epoch_paddle(inputs, labels, model, criterion, optimizer, lr_scheduler,
...
def train_one_epoch_torch(inputs, labels, model, criterion, optimizer, lr_scheduler,
                          max_iter, reprod_logger):
    for idx in range(max_iter):
